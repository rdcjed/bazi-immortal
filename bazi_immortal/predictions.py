...
def _positive_career_detail(ss: str, mw: str, rw: str, ug: List[str]) -> str:
    """喜用神事业描述"""
    desc = {
        "正官": "官星（管理掌控之力）值月为喜→事业上有明确方向和贵人指引。上级赏识，升职或加薪机会显现。（大白话：这个月工作上有人赏识你，适合申请升职加薪）",
        "七杀": "七杀（攻坚挑战之力）为喜→压力转化动力！适合接手挑战性任务，能在高压下取得突破性成果。（大白话：这个月越有压力越出成绩，别怕难）",
        "正印": "印星（庇护学习之力）护身→事业平稳上升。适合学习充电、考取证书、夯实专业基础。（大白话：这个月适合读书学习，提升自己比啥都强）",
        "偏印": "偏印（偏门智慧之力）为喜→思路独特创意涌现。策划、研发、创意类工作如有神助。（大白话：这个月灵感爆棚，适合搞创意和策划）",
        "正财": "财星（稳定收入之力）为喜→正职收入稳定。工作表现受认可，付出有对等回报。（大白话：这个月干活值钱，努力就有回报）",
        "偏财": "偏财（意外进账之力）为喜→主业之外有额外收入机会。多劳多得，适合拓展副业。（大白话：这个月适合搞搞副业，有机会赚外快）",
        "比肩": "比肩（平辈帮衬之力）帮身→同事朋友大力相助。团队协作效果极佳，借力使力。（大白话：这个月团队给力，有朋友同事帮忙，事情好办）",
        "劫财": "劫财（竞争破财力）为喜→竞争转化为动力。良性竞争促使共同进步，但注意利益分配。（大白话：有竞争是好事但钱的事要分清楚）",
        "食神": "食神（才华输出之力）泄秀→才华充分展现。表达和创意能力突出，适合内容输出。（大白话：这个月表达能力在线，做内容/演讲/写作都很顺）",
        "伤官": "伤官（创新突破之力）为喜→创新能力强。适合开拓新项目和打破常规。保持谦逊，避免锋芒太露。（大白话：这个月脑子好使但别太嘚瑟，低调做事最稳妥）",
    }
...
def _negative_career_detail(ss: str, mw: str, rw: str) -> str:
    """忌神事业描述"""
    desc = {
        "正官": "官星（管理掌控之力）为忌→职场压力增大。上级要求严格、规则约束多。注意工作细节，避免失误被放大。（大白话：这个月领导盯得紧，做事细心点别出错）",
        "七杀": "七杀（攻坚挑战之力）为忌！事业阻力大增。可能有岗位调整、职责加重或小人作祟。不宜硬扛，学会借力。（大白话：这个月压力特别大，别硬撑，找人帮忙分担）",
        "正印": "印星（庇护学习之力）为忌→依赖心增强。做事拖沓效率低，需主动推进工作，不要被动等待。（大白话：这个月容易犯懒，别等着别人催，自己动起来）",
        "偏印": "偏印（偏门智慧之力）为忌→想法怪异不被理解。职场人际关系紧张，建议收敛锋芒，多听少说。（大白话：这个月少发表奇思妙想，低调做人）",
        "正财": "财星（稳定收入之力）为忌→为赚钱而劳累。工作强度增大但收入增长有限，注意性价比。（大白话：这个月钱不好赚，别拿健康换钱）",
        "偏财": "偏财（意外进账之力）为忌→主业外投入精力过多反而得不偿失。专注本职工作。（大白话：这个月别搞副业了，专心做好主业）",
        "比肩": "比肩（平辈帮衬之力）为忌→同事间暗涌竞争。合作中注意明确分工和权益保护。（大白话：这个月同事关系微妙，做好自己的事就行）",
        "劫财": "劫财（竞争破财力）为忌！职场竞争激烈且小人潜伏。做好分内事不参与是非，留好工作记录。（大白话：这个月防小人！什么事都留个证据）",
        "食神": "食神（才华输出之力）为忌→过度放松影响工作状态。需收心专注，按计划推进。（大白话：这个月别太安逸，收收心干活）",
        "伤官": "伤官（创新突破之力）为忌！易出口舌是非，与上级关系紧张。谨言慎行，避免正面冲突。（大白话：这个月管住嘴，别和领导抬杠）",
    }
